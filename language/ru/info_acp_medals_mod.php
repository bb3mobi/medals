...
$lang = array_merge($lang, array(
	...
	'MEDALS_MOD_INSTALLED'			=> 'Расширение наград (Medals System) версии %s установлен',
	'MEDALS_MOD_UPDATED'			=> 'Расширение наград (Medals System) обновлен до версии %s',
	'MEDALS_MOD_MANUAL'				=> 'У вас установлена слишком старая версия мода наград (Medals System).<br />Вам нужно сначала удалить установленную версию.<br />Но перед этим убедителсь, что вы сделали полный бекап.',

	'ACL_U_AWARD_MEDALS'			=> 'Может выдавать награды',
	'ACL_U_NOMINATE_MEDALS'			=> 'Может номинировать на выдачу наград',
	'ACL_A_MANAGE_MEDALS'			=> 'Может пользоваться модулем управления наградами',
