...
$lang = array_merge($lang, array(
	...
	'MEDALS_MOD_MANUAL'				=> 'У вас установлена слишком старая версия мода наград (Medals System).<br />Вам нужно сначала удалить установленную версию.<br />Но перед этим убедитесь, что вы сделали полный бекап.',
